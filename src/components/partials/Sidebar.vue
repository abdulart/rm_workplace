    ...
    data: function() {
        return {
            paths: [
                ...
                {route: '/manager/dashboard', name: 'Дэшборд хантер', key: 'prospects'},
                {route: '/manager/headdashboard', name: 'Дэшборд руководитель', key: 'prospects'},                  
                ...
                {route: '/agents', name: 'Список агентов', key: 'agents'},
            ...
            particles: [                
                ...
                {id: 3, name: 'Агенты', key: 'agents'},
                {id: 4, name: 'Руководитель', key: 'manager'},
